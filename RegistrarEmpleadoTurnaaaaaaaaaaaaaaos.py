import csv
from PyQt6.QtWidgets import QWidget, QApplication,QDateTimeEdit, QComboBox, QMainWindow, QLabel, QVBoxLayout, QPushButton, QDialog, QMessageBox, QLineEdit, QHBoxLayout,QListWidget
...
class VentanaModificar(QDialog):
    def __init__(self):
        ...
        self.turnos = QListWidget()
        self.boton_aceptar = QPushButton("modificar")
        #Config
